...
(function () {
  ...
  var SAFE_SOURCES = new Set(['homepage', 'homepage-hero', 'homepage-advanced', 'emergency', 'implants', 'full-arch', 'all-on-4', 'implant-candidacy', 'implant-cost', 'cosmetic', 'new-patient-offer', 'wisdom-teeth-offer', 'google-business', 'post-visit', 'testimonials']);
